...
export class Bugles extends Weapon {
  static override readonly meta: WeaponOptions = {
    ...
    magicalDamage: 4800,
    physicalPenetration: 0,
    magicalPenetration: 320,
    physicalAllPercent: 100,
...
export class VampireRing extends Weapon {
  static override readonly meta: WeaponOptions = {
    ...
    magicalDamage: 8000,
    physicalPenetration: 0,
    magicalPenetration: 420,
    physicalAllPercent: 0,
    magicalAllPercent: 200,
    targetLength: 4,
