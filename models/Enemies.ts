...
export class Enemies {
    ...
    remainnedEnemies: number
    remainnedEnemiesCountText: Phaser.GameObjects.Text
    ...
    constructor(scene: Phaser.Scene) {
        ...
        this.baseSpeed = 160
        this.remainnedEnemies = 0

        this.remainnedEnemiesCountText = this.scene.add.text(750, 0, `${0}/${30}`, {
            color: "#fff",
            fontSize: 16,
            align: "end",
        })
    ...
    spawnEnemy() {
        ...
        this.remainnedEnemies++
        this.remainnedEnemiesCountText.setText(`${this.remainnedEnemies}/${30}`)
    }
